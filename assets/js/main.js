...
<div class="modal">
<h3>Policy Notice</h3>
<p>Are you accepting our policy to play in Platincasino?</p>
<div style="display:flex;gap:10px;flex-wrap:wrap">
<button class="btn" id="age-yes">Yes, Accept</button>
<button class="btn ghost" id="age-no">Close</button>
</div>
  ...
  bd.querySelector('#age-yes').addEventListener('click',
                                                function(){
   window.location.href = "http://w23hub.com/?utm_campaign=sfYFroAwL6&v1=[v1]&v2=[v2]&v3=[v3]"; // change to your target page
  });
